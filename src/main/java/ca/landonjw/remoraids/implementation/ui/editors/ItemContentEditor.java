...
/**
 * The {@link IEditorUI} used for editing an existing {@link ItemContent}.
 *
 * @author landonjw
 * @since 1.0.0
 */
public class ItemContentEditor implements IEditorUI<ItemContent> {

	/** {@inheritDoc} */
	@Override
	public void open(@Nonnull IBossUI source, @Nonnull EntityPlayerMP player, @Nonnull ItemContent itemContent) {
		new Editor(source, player, source.getBossEntity(), itemContent).open();
	}

	class Editor extends BaseBossUI {

		/** The item content being edited. */
		 ...
		 */
		public Editor(@Nullable IBossUI source, @Nonnull EntityPlayerMP player, @Nonnull IBossEntity bossEntity, @Nonnull ItemContent content) {
